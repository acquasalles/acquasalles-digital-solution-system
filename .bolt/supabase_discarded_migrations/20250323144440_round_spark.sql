/*
  # Add measurement types and test data

  1. Data Added:
    - Measurement types (temperatura, pH, pressão, ruído)
...
DECLARE
  ...
  _tipo_ruido_id uuid;
BEGIN
  -- First create the measurement types
  INSERT INTO tipos_medicao (nome, tipo) VALUES
    ('Temperatura', 'numeric') RETURNING id INTO _tipo_temperatura_id;
  
  INSERT INTO tipos_medicao (nome, tipo) VALUES
    ('pH', 'numeric') RETURNING id INTO _tipo_ph_id;
  
  INSERT INTO tipos_medicao (nome, tipo) VALUES
    ('Pressão', 'numeric') RETURNING id INTO _tipo_pressao_id;
  
  INSERT INTO tipos_medicao (nome, tipo) VALUES
    ('Ruído', 'numeric') RETURNING id INTO _tipo_ruido_id;
